...
class MicroPost
{
    ...
    #[Assert\NotBlank()]
    #[Assert\Length(min:5,max:255,minMessage: 'タイトルは5文字以上で入力してください。',maxMessage: 'タイトルは255文字以内で入力してください。')]
    private ?string $title = null;

    #[ORM\Column(length: 500)]
    #[Assert\NotBlank()]
    #[Assert\Length(min:5,max:500,minMessage: '本文は5文字以上で入力してください。',maxMessage: '本文は500文字以内で入力してください。')]
